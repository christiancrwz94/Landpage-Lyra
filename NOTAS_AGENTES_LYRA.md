...
## Protocolo de Preven��o de Regress�es

> [!IMPORTANT]
> A partir de agora, todas as regras estritas de seguran�a (como proibi��o de \git checkout\, manipula��o segura de uploads, bloqueio de mascaramento de erros, etc.) est�o consolidadas no arquivo mestre **\../applyra/.agents/AGENTS.md\** (Regra 31). Consulte sempre aquele arquivo como a fonte �nica da verdade sobre protocolos de seguran�a de IA.
